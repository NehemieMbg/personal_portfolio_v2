    ...
    <section className="max-w-wide mx-auto w-full pb-20">
      ...
      <div className="layout">
        <div className="flex gap-10 max-md:flex-col-reverse">
          <div className="flex flex-col gap-6 font-light text-neutral-400 w-1/2 pr-10 max-md:w-full max-md:pr-0">
        ...
        <div className="flex flex-col gap-14">
          <div className="flex items-center justify-between">
            ...
            <a
              ...
              className="bg-dark-gray py-3.5 px-6 border border-neutral-800 cursor-pointer rounded-full hover:bg-neutral-900 transition-colors duration-200 max-md:text-sm"
            >
              Download CV
            </a>
          </div>
          ...
          <div className="flex flex-col gap-8 max-md:gap-6">
            {about.experience.map((experience, index) => (
              <div
                key={index}
                className="flex max-md:flex-col max-md:gap-4 gap-10 font-light pb-8 max-md:pb-6 border-b border-b-neutral-800"
              >
                <p className="min-w-[240px] text-neutral-400">
                  {experience.date}
                </p>

                <div className="flex flex-col gap-6 max-md:gap-4 w-full">
                  <div>
