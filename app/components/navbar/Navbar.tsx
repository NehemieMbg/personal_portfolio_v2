    ...
    <>
      <nav className="relative max-w-wide w-full mx-auto flex justify-between items-center">
        ...
        <button
          ...
          className="fixed right-5 z-[80] hidden h-12 w-12 max-md:flex items-center justify-center aspect-square rounded-full overflow-hidden border border-neutral-800 bg-dark-gray hover:brightness-125 transition-brightness duration-200"
        >
